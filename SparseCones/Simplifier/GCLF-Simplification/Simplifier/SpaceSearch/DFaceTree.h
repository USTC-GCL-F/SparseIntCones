...
#include "DynamicAABB/DAABBTree.h"
#include "Mesh/SurfaceMeshDefinition.h"
#include "Exact/Types.h"
#include <utility>
#include <stack>
...
public:
  ...
  {
    DTriInterTrait trait(this, p, q, r, ep, eq, er, std::forward<IgnoreT>(ignore_triangles));
    traversal(trait);
    return trait.result();
  }
